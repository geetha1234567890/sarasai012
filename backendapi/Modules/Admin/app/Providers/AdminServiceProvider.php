...
class AdminServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        // $this->mergeConfigFrom(module_path($this->moduleName, 'config/global_constant.php'), 'Admin');

        // For multiple config files
        $configPath = module_path($this->moduleName, 'config');
        $configs = $this->loadConfigsFromDirectory($configPath);
     ...
     * @return array
     */
    protected function loadConfigsFromDirectory($directory)
    {
        $configs = [];
